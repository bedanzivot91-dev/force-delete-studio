...
(() => {
  ...
  css.textContent = `
    ...
    body.sps-modern-2026 .brand span{font-size:11px;letter-spacing:.15em}
    body.sps-modern-2026 .modern-brand-year{font-size:11px!important}
    body.sps-modern-2026 .nav-group-title{font-size:11px;letter-spacing:.13em}
    body.sps-modern-2026 .nav-item{font-size:14px;min-height:46px}
    body.sps-modern-2026 .nav-more>summary{font-size:11.5px;letter-spacing:.11em}
    body.sps-modern-2026 .connection{font-size:12.5px}
    body.sps-modern-2026 .version{font-size:12px;line-height:1.45}

    body.sps-modern-2026 .topbar h1{font-size:27px}
    body.sps-modern-2026 .topbar p{font-size:14px}
    body.sps-modern-2026 .modern-top-badge{font-size:11.5px}
    body.sps-modern-2026 .modern-quick-skin span{font-size:11px}
    ...
    body.sps-modern-2026 .pws-track-label,body.sps-modern-2026 .pws-editor-head,body.sps-modern-2026 .pws-tick{font-size:11.5px}
