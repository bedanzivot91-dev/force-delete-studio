...
setup_all = '\n'.join(p.read_text(encoding='utf-8') for p in sorted(SETUP_DIR.glob('*.go')))
...
for obsolete in ('3.13.14','3.14.6','ffmpeg-8.1.2-essentials_build','ffmpeg-release-essentials','/v2.8.1/'):
